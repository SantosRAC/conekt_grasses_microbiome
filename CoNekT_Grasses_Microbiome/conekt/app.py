...
def configure_blueprints(app):
    ...
    from conekt.controllers.microbiome.custom_microbiome_network import micro_custom_network
    ...
    from conekt.controllers.omics_integration.custom_expression_microbiome_network import exp_micro_custom_network
    ...
    app.register_blueprint(exp_micro_custom_network, url_prefix='/exp_micro_custom_network')
    app.register_blueprint(micro_custom_network, url_prefix='/micro_custom_network')
...
def configure_admin_panel(app):
    ...
    if LOGIN_ENABLED:
        ...
        from conekt.controllers.admin.views.microbiome.otus import AddOTUAssociationsView
        ...
        from conekt.controllers.admin.views.omics_integration.expression_microbiome_correlations import \
        ...
        admin.add_view(AddOTUAssociationsView(name='Microbial Associations',
                                                 endpoint='admin_add_otu_associations',
                                                 url='add/otu_associations/', category='Add Microbiome Data'))
